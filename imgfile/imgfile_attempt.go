...
// }
// func New(path os.DirEntry, prefix string) *ImgFiler {
...
// }
// func newImgFile(fileinfo os.FileInfo, fname string, fExtension string, prefix string) (*ImgFiler) {
// 	if fExtension == "" {
...
// type LabeledImgFile struct {
// 	ImgFile
// 	isLabeled bool
// }

// // expect string in a format eg. "20220102_landscape_1.JPEG"
// func newWithDate(fileinfo os.FileInfo, fname string, fExtension string) (*LabeledImgFile) {
...
// 	//seems theres' no shortcut for instantiation
// 	newFile := LabeledImgFile{}
// 	newFile.labels = label //here it is the label
// 	newFile.prefix = splitString[0]
// 	newFile.enum =  fenum //
// 	newFile.extension = fExtension
// 	newFile.full_name = fname
// 	newFile.generated_date = unix_filetime(fileinfo)
// 	newFile.isLabeled = true
		
// 	log.Debug().Str("func", "newWithDate").Msg("creating file from date " + newFile.labels + newFile.prefix + strconv.Itoa(newFile.enum) + newFile.extension + newFile.full_name + newFile.generated_date)
// 	return &newFile
// }
